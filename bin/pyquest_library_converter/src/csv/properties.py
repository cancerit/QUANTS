...
#         able to detect the delimiter and falling back to the delimiter specified
#         by the user.
#         """
...
#         dialect, safe_delimiter = cls._get_safe_dialect_and_delimiter(
...
#     @staticmethod
#     def _get_safe_dialect_and_delimiter(
#         csv_file_path: t.Union[str, Path],
#         prefix: str,
...
#     delimiters: t.Optional[str] = None,
# ) -> Dialect:  # noqa: C901
#     err_msg = f"Could not determine CSV delimiter for file {str(csv_file_path)!r}"
