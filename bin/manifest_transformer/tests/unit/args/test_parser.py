...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "column-names in.csv --force-header-row-index 1 -c col1 col2 -C opt-col4 opt-col5 -c col3 -o out.csv --output-as-tsv -r col1=COL1 col3=COL3 -s summary.json",
            id="3",
        ),
        pytest.param(
            "column-names in.csv -c col1 col2 -C opt-col4 opt-col5 -c col3 -o out.csv --output-as-tsv -r col1=COL1 col3=COL3 -s summary.json",
            id="4",
        ),
        pytest.param(
            "column-names in.csv -c col1 col2 -C opt-col4 opt-col5 -c col3 -o out.csv -r col1=COL1 col3=COL3 -s summary.json",
            id="5",
        ),
        pytest.param(
            "column-names in.csv -c col1 col2 -C opt-col4 opt-col5 -c col3 -o out.csv -s summary.json",
            id="6",
        ),
        pytest.param(
            "column-names in.csv -c col1 col2 -C opt-col4 opt-col5 -c col3 -o out.csv",
            id="7",
        ),
        pytest.param(
            "column-names in.csv -c col1 col2 -C opt-col4 opt-col5 -c col3",
            id="8",
        ),
    ],
)
